      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 hover:border-slate-300 dark:hover:border-slate-700/80 shadow-sm dark:shadow-none transition-all">
            <div className="w-10 h-10 bg-emerald-500/10 border border-emerald-500/20 text-xl rounded-xl flex items-center justify-center mb-4">
              🔥
            </div>
          ...
          {/* Feature 2 */}
          <div className="bg-white dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 hover:border-slate-300 dark:hover:border-slate-700/80 shadow-sm dark:shadow-none transition-all">
            <div className="w-10 h-10 bg-amber-500/10 border border-amber-500/20 text-xl rounded-xl flex items-center justify-center mb-4">
              🥩
            </div>
          ...
          {/* Feature 3 */}
          <div className="bg-white dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 hover:border-slate-300 dark:hover:border-slate-700/80 shadow-sm dark:shadow-none transition-all">
            <div className="w-10 h-10 bg-sky-500/10 border border-sky-500/20 text-xl rounded-xl flex items-center justify-center mb-4">
              🏃‍♂️
            </div>
