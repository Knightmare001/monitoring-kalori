...
import { Scale, TrendingDown, Trash2 } from "lucide-react";
    ...
    <>
      ...
      <div className="card p-5 flex flex-col gap-5">
        <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
          <Scale size={18} className="text-slate-500 dark:text-slate-400" strokeWidth={2.2} />
          Progres Berat Badan
        </h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="date"
                    className="input-field w-full bg-slate-50 dark:bg-slate-900 border rounded-xl py-2 pr-3 pl-10 text-sm focus:outline-none focus:border-emerald-500 text-slate-900 dark:text-slate-100
          ...
          <div className="flex flex-col gap-3">
            ...
            {chartData.length >= 2 ? (
              ...
              <div className="h-64 flex flex-col items-center justify-center text-center gap-2 bg-slate-50 dark:bg-slate-950 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-800">
                <TrendingDown size={28} className="text-slate-300 dark:text-slate-700" strokeWidth={1.8} />
      ...
      {msg && <Toast message={msg.text} type={msg.type} onDismiss={() => setMsg(null)} />}
    </>
  );
}
